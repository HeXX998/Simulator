...
public class IntegerDialog {
	...
	public IntegerDialog(MainGui mainGui) {
		this.mainGui = mainGui;
		
		memory = new JFrame("Integer Register Settings");
		...
		JLabel addressLabel = new JLabel("No.");
	...
	private class ConfirmListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			mainGui.getIntegerDialog(Integer.parseInt(address.getText()), Integer.parseInt(value.getText()));
