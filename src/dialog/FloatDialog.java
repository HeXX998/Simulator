...
public class FloatDialog {
	...
	public FloatDialog(MainGui mainGui) {
		this.mainGui = mainGui;
		
		memory = new JFrame("Float Register Settings");
	...
	private class ConfirmListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			mainGui.getFloatDialog(Integer.parseInt(address.getText()), Float.parseFloat(value.getText()));
